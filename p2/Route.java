...
public class Route {
    ...
    public boolean canGetTo(String station) {
        ...
        for (int i = 0; i < segments.size(); i++) {
            ...
            if (i == segments.size() - 1 && segment.getEndStation().getName().equals(station)) {
                // Last segment's end station matches the specified station
                return true;
            }
            if (segment.getStartStation().getName().equals(station)) {
    ...
    public void changeLight(String startOfSegment) {
        ...
        for (Segment segment : segments) {
            if (segment.getStartStation().getName().equals(startOfSegment)) {
